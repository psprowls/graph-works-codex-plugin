...
> **For agentic workers:** REQUIRED SUB-SKILL: Use graph-works:subagent-driven-development (recommended) or graph-works:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.
...
- **REQUIRED SUB-SKILL:** Use graph-works:subagent-driven-development
- Fresh subagent per task + two-stage review

**If Inline Execution chosen:**
- **REQUIRED SUB-SKILL:** Use graph-works:executing-plans
