...
digraph process {
    ...
    "Use graph-works:finishing-a-development-branch" [shape=box style=filled fillcolor=lightgreen];
    ...
    "Final review clean: delete this plan's workspace" -> "Use graph-works:finishing-a-development-branch";
}
```
...
graph-works:requesting-code-review's
...
Use graph-works:finishing-a-development-branch.
...
Done! Using graph-works:finishing-a-development-branch.
```
